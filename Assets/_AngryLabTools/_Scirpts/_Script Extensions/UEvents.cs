...
namespace AngryLab
{
    public sealed partial class UEvents
    {
        ...
        /// <summary>
        /// Allows you to pass a EmptyClass value through the Event
        /// </summary>
        [System.Serializable]
        public class EVoid : UnityEvent<EmptyClass> { }

        /// <summary>
        /// Allows you to pass a SO_GeneralSettings value through the Event
        /// </summary>
        [System.Serializable]
        public class EGeneralSettings : UnityEvent<SO_GeneralSettings> { }
    }
}